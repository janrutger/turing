...
def loadlibrary():
    ...
    library["RWD"] = (
        # ("START", {"ST":"_"}, ({"ST":"_"}, {"ST":"L"}, "START")),
        # ("START", {"ST":"1"}, ({"ST":"1"}, {"ST":"L"}, "loop")),
        # ("START", {"ST":"0"}, ({"ST":"0"}, {"ST":"L"}, "loop")),

        # ("loop",  {"ST":"_"}, ({"ST":"_"}, {"ST":"R"}, "HALT")),
        # ("loop",  {"ST":"1"}, ({"ST":"1"}, {"ST":"L"}, "loop")),
        # ("loop",  {"ST":"0"}, ({"ST":"0"}, {"ST":"L"}, "loop")),
    ...
    library["_LDA"] =   (
        ("D", {"ST":"1", "RA":"_"}, ({"ST":"_", "RA":"1"}, {"ST":"L", "RA":"L"}, "HALT")),
